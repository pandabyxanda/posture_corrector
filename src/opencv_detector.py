...
class Detector():
    def __init__(self, camera=0, draw=False):
        self.draw = draw
    ...
    def check_posture(self):
        ...
        if results.pose_landmarks:
            ...
            # ears and nose, find angle between 2 lines
            ...
            if self.draw:
                # shoulders and shoulders center draw
            ...
            # # find angle between 2 lines, trying to get back straight. Working badly
...
if __name__ == "__main__":
    dt = Detector(0, draw=True)
    while True:
        alpha = dt.check_posture()
        print(f"{alpha = }")
        cv2.waitKey(1)
